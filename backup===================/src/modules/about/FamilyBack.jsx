          ...
          <div className="col-12">
            <div className="imgText">
              ...
              <figure className="img">
                ...
                <div className="images">
                  <figcaption>
                    <img data-src={img6} data-aos="fade-left" />
                    <img data-src={img6_1} data-aos="fade-right" />
                    <img data-src={img6_2} data-aos="fade-left" />
                    <img data-src={img6_3} data-aos="fade-right" />
                    <img data-src={img6_4} data-aos="fade-left" />
                    <img data-src={img6_5} data-aos="fade-right" />
                  </figcaption>
              ...
              <figure className="img">
                ...
                <div className="images">
                  <figcaption>
                    <img data-src={img7} data-aos="fade-left" />
                    <img data-src={img7_1} data-aos="fade-right" />
                    <img data-src={img7_2} data-aos="fade-left" />
                    <img data-src={img7_3} data-aos="fade-right" />
