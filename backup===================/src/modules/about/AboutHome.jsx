          ...
          <div className="cols3">
            ...
            <div className="cnt">
              ...
              <div className="cnt">
                ...
                <p>My aunt, Nusrat Waseem, is a Bollywood playback singer who has performed in films, albums, TV shows, live concerts, and international events. She appeared on Doordarshan’s Meri Awaaz Suno and was a runner-up in the 2016 Sony SAB Antakshari competition. She has also worked with singer Altaf Raja, contributed to the film Tarazu, and continues her active singing career. She has been honored with the Adharshila Best Female Singer Award (presented by the President of India, Mr. Shankar Dayal Sharma) and the Best Singer Award by Venus Records and Tapes Company. She currently runs a Mumbai-based music studio called “Musica”, where she trains aspiring singers.</p>
                <p>Below are the links to Recorded Songs & Qawwalis:-</p>
                <ul className="lists songs">
                  <li><a href="https://www.youtube.com/results?search_query=Khwaja+Ki+Hai+Ye+Angnayee+Altaf+Raja&utm_source=chatgpt.com" target="_blank">Khwaja Ki Hai Ye Angnayee (With Altaf Raza)</a></li>
                  <li><a href="https://www.youtube.com/results?search_query=Jogan+Aayee+Altaf+Raja&utm_source=chatgpt.com" target="_blank">Jogan Aayee (With Altaf Raza)</a></li>
                  <li><a href="https://www.youtube.com/results?search_query=Chali+Chali+Woh+Sharaab+Altaf+Raja&utm_source=chatgpt.com" target="_blank">Chali Chali Woh Sharaab (With Altaf Raza)</a></li>
                  <li><a href="https://www.youtube.com/results?search_query=Ya+Habibe+Khuda+Altaf+Raja&utm_source=chatgpt.com" target="_blank">Ya Habibe Khuda (With Altaf Raza)</a></li>
                  <li><a href="https://www.youtube.com/results?search_query=Shahe+Sanjar+Ke+Dar+Ki+Altaf+Raja&utm_source=chatgpt.com" target="_blank">Shahe Sanjar Ke Dar Ki (With Altaf Raza)</a></li>
                  <li><a href="https://www.youtube.com/results?search_query=Nazar+Na+Hate+Mere+Yaar+Se+Tarazu&utm_source=chatgpt.com" target="_blank">Nazar Na Hate Mere Yaar Se (Tarazu movie)</a></li>
                </ul>

                <p>I am known as a stylish cricketer with natural sporting ability since childhood and active involvement in cricket as an all-rounder. I am recognized for my strong batting technique, preference for long innings, solid straight-bat play, consistent timing, good footwork, body control, classic cricketing shots, and disciplined batting style. As a pace bowler, I once broke a batsman’s helmet with a sharp bouncer and also broke the stumps many times with fast deliveries. In fielding, I was known as a sharp and agile fielder. I participated in state-level open tournaments across multiple states in India, competing with and against players from Uttar Pradesh, Delhi, Haryana, Uttarakhand, Madhya Pradesh, Bihar, Himachal Pradesh, Maharashtra, West Bengal, and Tamil Nadu. I also shared the field with players associated with state-level tournaments, the Ranji Trophy, and the IPL. I am deeply passionate about cricket and played at school, club, and corporate levels.</p>
