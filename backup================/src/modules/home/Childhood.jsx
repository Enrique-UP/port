            ...
            <div className="row">
              ...
              <div className="col-lg-6" data-aos="fade-left">
                <div className={`content ${active ? "active" : ""}`}>
                  <p>I was born into a loving family and grew up in a well-cared environment. I was born after a long time, so everyone loved me very much as a child. Especially my grandmother loved me deeply, as I was very dear to her. When I was born, my family celebrated with great joy, and there was a three-day celebration.</p>
